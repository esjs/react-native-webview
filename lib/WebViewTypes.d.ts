...
declare type WebViewCommands = 'goForward' | 'goBack' | 'reload' | 'stopLoading' | 'postMessage' | 'injectJavaScript' | 'loadUrl' | 'getAllCookies' | 'requestFocus';
...
export interface IOSWebViewProps extends WebViewSharedProps {
    ...
    onFileDownload?: (event: FileDownloadEvent) => void;
    /**
     * Callback function on cookies recieved after calling getAllCookies
     *
     * !!!IMPORTANT!!!! iOS only!!!!
     */
    onCookiesRecieved: (cookies: NativeSyntheticEvent<WebViewCookies>) => void;
}
